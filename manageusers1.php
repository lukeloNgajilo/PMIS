		...
		<div id="left-sidebar" class="sidebar">
			...
			<div class="sidebar-scroll">
				<div class="user-account">
					<img src="assets/img/user1.jpg" class="img-responsive img-circle user-photo" alt="User Profile Picture"
					style="height: 150px; width: 150px;">
					<div class="dropdown">
						<a href="#" class="dropdown-toggle user-name" data-toggle="dropdown">Hello, <strong>Angelo Thomas</strong> <i class="fa fa-caret-down"></i></a>
				...
				<nav id="left-sidebar-nav" class="sidebar-nav">
					<ul id="main-menu" class="metismenu">
						...
						<li class="">
							<a href="addprojects.php" style="border-bottom: 1px solid #fff;"><i class="lnr lnr-magic-wand"></i> <span>Add Project</span></a>
						</li>
						<li class="">
							<a href="#" style="border-bottom: 1px solid #fff;"><i class="lnr lnr-file-empty"></i> <span>Project Details</span></a>
						</li>
						<li class="">
							<a href="#" style="border-bottom: 1px solid #fff;"><i class="lnr lnr-pencil"></i> <span>Implementaion status</span></a>
						</li>
						<li class="">
							<a href="#" style="border-bottom: 1px solid #fff;"><i class="lnr lnr-chart-bars"></i> <span>Reports</span></a>
						</li>
						<li class="">
							<a href="manageusers.php" style="border-bottom: 1px solid #fff;"><i class="lnr lnr-chart-bars"></i> <span>Manage users</span></a>
						</li>
					</ul>
				</nav>
			</div>
